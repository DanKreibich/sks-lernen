...
ActiveRecord::Schema[7.0].define(version: 2023_01_28_164739) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "learning_logs", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "theory_question_id", null: false
    t.integer "counter_correctly_answered"
    t.integer "counter_incorrectly_answered"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["theory_question_id"], name: "index_learning_logs_on_theory_question_id"
  ...
  add_foreign_key "learning_logs", "theory_questions"
